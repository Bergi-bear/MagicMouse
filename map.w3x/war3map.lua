...
function ShapeInit()
    square = Shape:new(function(sumOfAngles, angles, sides)
        for i = 1, #angles do if (angles[i] < 75) then return false end end
        return Interval(sumOfAngles, 260, 450) and Interval(#sides, 4, 5) and Distance(sides[1].start, sides[#sides].en) < 3/2 * 128
    end, function() print("It's definitely a Square!") end)

    triangle = Shape:new(function(sumOfAngles, angles, sides)
        for i = 1, #angles do if (angles[i] < 80) then return false end end
        return Interval(sumOfAngles, 300, 420) and Interval(#sides, 3, 3) and Distance(sides[1].start, sides[#sides].en) < 3/2 * 128
    end, function() print("It's definitely a Triangle!") end)
    ...
    end, function() print("It's definitely a Circle!") end)
    ...
    end, function() print("It's definitely a Line!") end)
    ...
    end, function() print("It's definitely a Z shape!") end)
